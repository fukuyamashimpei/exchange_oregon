...
function play(clickedButton) {
    ...
    displayResult(`<img src="${clickedButton}.png" alt="${clickedButton}" width="50" height="50">`, "humanChoiceCell");
    displayResult(`<img src="${computerChoice}.png" alt="${computerChoice}" width="50" height="50">`, "computerChoiceCell");
    displayResult(`<p>${result}</p>`, "resultCell");
